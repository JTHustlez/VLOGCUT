  ...
  return (
    <div className="flex justify-center gap-4 leading-16">
      <div ref={containerRef} className="relative -rotate-[2.76deg] mt-0.5">
        <div className="absolute inset-0 w-full h-full rounded-2xl border border-primary/60 flex justify-between z-1 shadow-[0_0_15px_hsl(185,100%,50%,0.3)]">
          <motion.div
            className="absolute z-10 left-0 h-full border border-primary/60 w-7 rounded-full bg-background flex items-center justify-center select-none shadow-[0_0_10px_hsl(185,100%,50%,0.4)]"
            style={{
              x: leftHandleX,
            }}
            drag="x"
          ...
          >
            <div className="w-2 h-8 rounded-full bg-gradient-to-b from-primary to-[hsl(210,100%,60%)]" />
          </motion.div>

          <motion.div
            className="absolute z-10 -left-[30px] h-full border border-primary/60 w-7 rounded-full bg-background flex items-center justify-center select-none shadow-[0_0_10px_hsl(185,100%,50%,0.4)]"
            style={{
              x: rightHandleX,
            }}
            drag="x"
