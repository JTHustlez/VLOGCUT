...
export function EditorHeader() {
    ...
    <div className="flex items-center gap-3">
      <Link href="/projects" className="flex items-center gap-2 group">
        <Image
          ...
          width={20}
          height={20}
          className="w-5 h-5 transition-all duration-300 group-hover:drop-shadow-[0_0_6px_hsl(45,67%,52%,0.5)]"
        />
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="secondary"
            className="h-auto py-1.5 px-2.5 flex items-center justify-center border-border/30 hover:border-primary/30"
          >
  ...
  return (
    <HeaderBase
      ...
      className="bg-card/50 backdrop-blur-xl border-b border-border/30 h-[3.2rem] px-3 items-center mt-0.5"
    />
  );
}
